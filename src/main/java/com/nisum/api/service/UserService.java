...
import com.nisum.api.util.HandlerException.UserConflictException;
import com.nisum.api.util.HandlerException.UserValidationException;
import com.nisum.api.util.mapper.UserMapper;
...
public class UserService {
    ...
    public UserResponseDTO createUser(User user) {
        try {
            // Valida que el email no este registrado y que ambos (email & password) cumplan con los formatos requeridos
            ...
            // Captura la excepción de validación y lanza una nueva excepción de validación del usuario
            throw new UserValidationException(e.getMessage());
        } catch (UserConflictException e) {
            // Captura la excepción de conflicto y lanza una nueva excepción de conflicto del usuario
    ...
    private void validateEmail(String email) {
        ...
        if (!matcher.matches()) {
            throw new UserValidationException("El correo tiene un formato incorrecto");
        }
        if (userRepository.findByEmail(email).isPresent()) {
            throw new UserConflictException("El correo " + email + " ya está registrado");
        }
    }
    ...
    private void validatePassword(String password) {
        ...
        if (!matcher.matches()) {
            throw new UserValidationException("La contraseña tiene un formato incorrecto");
        }
    }
